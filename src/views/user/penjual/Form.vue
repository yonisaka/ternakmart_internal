...
export default {
    ...
    mounted() {
        this.id_penjual = this.$route.params.id || ''
        if (this.$route.params.id){
            axios
            .get("/penjual/"+ this.$route.params.id)
            .then((res) => {
                this.form = res.data.penjual
            })
    ...
    methods: {
        onSubmit() {
            ...
            if (this.$route.params.id){
                ...
                .then(() => {
                    ApiService.put("penjual/" + this.id_penjual, this.form)
                    .then(() => {
                        this.snackbar = true
                        this.message = 'Berhasil Update Data'
                        this.color = '#139CA4'
                        setTimeout( () => this.$router.push({ path: '/user/penjual'}), 1000);
